...
@interface ImageCropViewController : UIViewController  <unWineActionSheetDelegate > {
    ImageCropView * cropView;
    unWineActionSheet * actionSheet;
}
@property (nonatomic, weak) id<ImageCropViewControllerDelegate> delegate;
@property (nonatomic, retain) unWineActionSheet * actionSheet;
@property (nonatomic, retain) UIImage* image;
