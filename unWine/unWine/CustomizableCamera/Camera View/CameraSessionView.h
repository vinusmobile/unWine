...
@optional - (void)didCaptureMovieWithData:(NSData *)movieData url:(NSURL *)url thumbnail:(UIImage *)thumbnail;
@optional - (void)willDismissCameraSessionView:(BOOL)animated;
