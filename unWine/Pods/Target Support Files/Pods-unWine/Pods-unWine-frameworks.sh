...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/GCPlaceholderTextView/GCPlaceholderTextView.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/NSDate-Time-Ago/NSDate_Time_Ago.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/UIBarButtonItem-Badge/UIBarButtonItem_Badge.framework"
